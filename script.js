    ...
    <nav id="navbar">
        <div class="container nav-container">
            <a href="#home" class="logo">
                <img class="logo-img" src="assets/Dexuan_logo_bg.png" alt="DeXuan Character Learning Hub logo">
                <span class="logo-text" data-translate="logo_text">DeXuan<br><small>Character Learning Hub</small></span>
            </a>
            <div class="nav-links">
...
<footer>
    <div class="container text-center">
        <a href="index.html" class="footer-brand">
            <img class="footer-logo-img" src="assets/Dexuan_logo_footer.png" alt="DeXuan Character Learning Hub logo">
            <span class="footer-logo-text" data-translate="logo_text">DeXuan<br><small>Character Learning Hub</small></span>
        </a>
        ...
        <div class="footer-links" style="margin: 15px 0;">
            <a href="privacy.html" target="_blank" data-translate="footer_privacy" style="color: rgba(255, 255, 255, 0.7); text-decoration: none; font-size: 0.95rem; transition: color 0.3s ease;" onmouseover="this.style.color='#ffffff'" onmouseout="this.style.color='rgba(255, 255, 255, 0.7)'">Privacy Statement</a>
        </div>
        <p class="copyright" data-translate="footer_copy">&copy; 2026 DeXuan Character Learning Hub. All rights
            reserved.</p>
    </div>
</footer>`;
}
