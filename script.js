    ...
    <nav id="navbar">
        <div class="container nav-container">
            <a href="#home" class="logo">
                <img class="logo-img" src="assets/Dexuan_logo_bg.png" alt="DEXUAN Character Development logo">
                <span class="logo-text" data-translate="logo_text">DEXUAN<br><small>Character Development</small></span>
            </a>
            <div class="nav-links">
...
<footer>
    <div class="container text-center">
        <a href="index.html" class="footer-brand">
            <img class="footer-logo-img" src="assets/Dexuan_logo_footer.png" alt="DEXUAN Character Development logo">
            <span class="footer-logo-text" data-translate="logo_text">DEXUAN<br><small>Character Development</small></span>
        </a>
        ...
        <p class="copyright" data-translate="footer_copy">&copy; 2026 DEXUAN Character Development. All rights
            reserved.</p>
    </div>
</footer>`;
}
